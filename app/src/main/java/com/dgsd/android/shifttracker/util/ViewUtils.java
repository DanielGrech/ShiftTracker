...
public class ViewUtils {
    ...
    public static void beginAnimation(ViewGroup rootView) {
        if (rootView != null) {
    ...
    @ColorInt
    public static int extractThemeColor(Context context, @AttrRes int colorThemeAttr, @ColorInt int defaultColor) {
        TypedValue value = new TypedValue();
        if (!context.getTheme().resolveAttribute(colorThemeAttr, value, true)) {
            return defaultColor;
        }
    ...
    public static void startActivity(@NonNull Intent intent, @NonNull View view) {
        ...
        context.startActivity(intent, createTransitionBundle(view));
    }
    ...
    public static void startActivityForResult(@NonNull Activity context, @NonNull Intent intent, int requestCode, @NonNull View view) {
        context.startActivityForResult(intent, requestCode, createTransitionBundle(view));
    }

    public static Bundle createTransitionBundle(View view) {
